...
# Parameters
data_folder = '/home/bringascastle/Descargas/Agustin Dataset/Images04respirator/Images04respirator/JSONFiles'
...
checkpoint = '/home/bringascastle/Documentos/repos/RetinaNet/checkpoints/RetinaNet_G_FT_epoca_25.pth.rar'
#checkpoint = '/home/fp/Escritorio/LuisBringas/FCOS/checkpoints/TransferLearning/prueba_TransferLearning.pth.rar'
...
def meanAP(data_loader_test, model):
    ...
    for im, annot in tqdm(data_loader_test, position = 0, leave = True):
        ...
        with torch.no_grad():
            preds_adj = make_prediction(model, im, 0.70)
