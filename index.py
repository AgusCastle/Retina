from RetinaNet import  RetinaNet_FineTuning, RetinaNet_TransferLearning, RetinaNet_FromScratch
...
def save_model(epoch, model, optim, name = None):
    if name is None:
        ...
        filename = '/home/bringascastle/Documentos/repos/RetinaNet/checkpoints/RetinaNet_FineTuning_G.pth.rar'
        ...
        filename = '/home/bringascastle/Documentos/repos/RetinaNet/checkpoints/{}.pth.rar'.format(name)
...
def main(checkpoint = None):
    ...
    dataset = Dataset_G('/home/bringascastle/Documentos/repos/RetinaNet/JSONfiles_G', 'TRAIN', get_transform(True))
    ...
    for epoch in range(start_epoch ,num_epochs):
        ...
        if epoch == 5:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_05")

        if epoch == 10:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_10")

        if epoch == 15:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_15")
        
        if epoch == 20:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_20")
        
        if epoch == 25:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_25")

        if epoch == 29:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_29")

        if epoch == 30:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_30")

        if epoch == 35:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_35")
        
        if epoch == 40:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_40")
        
        if epoch == 45:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_45")

        if epoch == 50:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_50")

        if epoch == 55:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_55")

        if epoch == 60:
            save_model(epoch, model, optimizer, "RetinaNet_G_FT_epoca_60")
...
main('/home/bringascastle/Documentos/repos/RetinaNet/checkpoints/RetinaNet_FineTuning_G.pth.rar')